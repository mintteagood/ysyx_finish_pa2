...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 01110 11", divuw ,  R, R(dest) = SEXT(BITS(BITS(src1,31,0) /(unsigned int)BITS(src2,31,0),31,0),32) , printf("current pc is %lx ",s->pc),printf("R(10) is:%lx\n",R(10)));
