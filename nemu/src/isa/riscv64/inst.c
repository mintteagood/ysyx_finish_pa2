...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai ,   I, R(dest) = SEXT(BITS((SEXT(src1,5) >> src2), 4, 0),5) ,printf("current pc is %lx ",s->pc),printf("R(10) is:%lx\n",R(10)));
...
//movsx
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00110 11", sraiw ,  I,  R(dest) = SEXT(BITS(SEXT(src1,32)>>src2,31,0),32) ,printf("current pc is %lx ",s->pc),printf("R(10) is:%lx\n",R(10)));
